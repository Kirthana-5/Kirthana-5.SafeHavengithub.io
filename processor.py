...
def getResponse(ints, intents_json, source_lang='en', target_lang='en', save_path="E:/OWN/2337-NISHA/HAND SIGN AND CHATBOT/HAND SIGN/Deploy/Responses/response.mp3"):
    tag = ints[0]['intent']
    list_of_intents = intents_json['intents']
    translator = Translator()
    for i in list_of_intents:
